                    ...
                    <div class="card card-body col-sm-12 col-md-10 bg-light align-self-center">
                        ...
                        <div class="row pb-5">
                            <div class="pb-3 align-self-center col-sm-12 col-md-8 offset-md-1">
                                <form action="/acces_partenaire/actualites" method="get">
                                    <input class="form-control" type="text" name="q" placeholder="{{ __('partnersAccess.placeholderactuality')}}">
                                </form>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="add_actualite_label"><b>{{ __('partnersAccess.addNew')}}</b></h4>
                                    ...
                                    <form class="form-outline" method="post" action="/acces_partenaire/actualites/create" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3 row">
                                                <label class="col-sm-3 col-form-label">{{ __('partnersAccess.title')}}</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="titre" class="form-control">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label class="col-sm-3 col-form-label">{{ __('partnersAccess.summary')}}</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label">{{ __('partnersAccess.event')}}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <small style="font-size: 10px;">{{ __('partnersAccess.chosePictureText')}}</small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary">{{ __('partnersAccess.addNow')}}</button>
                        ...
                        <div class="modal fade" id="update_actualite" tabindex="-1" aria-labelledby="update_actualite_label" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="update_actualite_label"><b>{{ __('partnersAccess.modify')}}</b></h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form id="update_form" class="form-outline" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3 row">
                                                <label class="col-sm-3 col-form-label">Image <small style="font-size: 10px;">({{ __('partnersAccess.optional')}})</small></label>
                                                <div class="col-sm-8">
                        ...
                        <div class="modal fade" id="delete_actualite" tabindex="-1" aria-labelledby="delete_actualite_label" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="delete_actualite_label"><b>{{ __('partnersAccess.delete')}}</b></h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body ml-5">
                                        <div class="row">
                                            <span>{{ __('partnersAccess.deleteConfirmation')}}</span><span>"<b id="actualite_title"></b>" ?</span>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <a id="delete_actualite_button" role="button" class="btn btn-primary">{{ __('partnersAccess.delete')}}</a>
                    ...
                    @if(!$actualites->count())
                            <div class='row align-self-center m-5'>
                                <div class="p-5 border-5">
                                    <h1>{{ __('partnersAccess.noActuality')}}</h1>
                                </div>
                            </div>
                        @else
                                ...
                                <table class="col-sm-12 col-md-12 table">
                                    ...
                                    @foreach($actualites as $actualite)
                                        <tr class="align-middle">
                                            ...
                                            <td>{{$actualite->type == 'evenement' ? __('partnersAccess.event') : __('partnersAccess.actualitiesRoot')}}</td>
                                            <td class="w-25">
                                                <a class="btn btn-success" href="/actualites/{{$actualite->id}}">{{ __('partnersAccess.print')}}</a>
